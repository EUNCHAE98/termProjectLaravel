...
?>
        ...
        <div class="content_nav">
            <button class="btn btn_link about_btn" type="button" onclick="location.href='#'">ABOUT 'SLIME'</button>
            <button class="btn btn_link community_btn" type="button" onclick="location.href='#'">
